        ...
        <StyledWrapper>
            <ul className="example-2">
                <li className="icon-content">
                    <a href="https://www.linkedin.com/in/galomartinez1/" aria-label="LinkedIn" data-social="linkedin">
                ...
                <li className="icon-content">
                    <a href="https://github.com/GaloMartinez" aria-label="GitHub" data-social="github">
                        <div className="filled" />
                ...
                <li className="icon-content">
                    <a data-social="whatsapp" aria-label="Whatsapp" href="https://wa.me/+541137918640">
                        <div className="filled" />
